...
router.post("/my-leave-balances", UserValidation.getMyLeaveBalances, UserController.getMyLeaveBalances);
router.post("/my-available-leaves", UserValidation.getMyAvailableLeaves, UserController.getMyAvailableLeaves);
